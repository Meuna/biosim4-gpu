...
- Show the full-run survival rate with a min/now/max readout in a responsive sparkline that widens with each generation up to the grid width ([#PRNUM](https://github.com/Meuna/biosim4-gpu/pull/PRNUM))
