...
- Resolve omitted barrier fields to fixed per-kind defaults instead of random values ([#197](https://github.com/Meuna/biosim4-gpu/pull/197))
...
- Reshape the idle kinematic sculpture into an oscillating wave surface that spans the viewport ([#173](https://github.com/Meuna/biosim4-gpu/pull/173))
