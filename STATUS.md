...
| `webapp` | Partially wired | Config panel wired for all 14 scalar params, challenge spec, and barriers (gh-56, gh-64); agent brain explorer wired to live `nnet` data (gh-74); simulation state machine encapsulated in the `SimMachine` class (composite phase × dirty state, gh-98). Preset loading and TOML export pending. |
