...
extern const char biosim_gpu_preamble_grid_defs_h[];
...
extern const char biosim_gpu_preamble_challenge_defs_h[];
...
biosim_status_t biosim_gpu_registry_get(const char *kernel_name, const char *exec_dir,
    ...
    out->sources[0] = biosim_gpu_preamble_grid_defs_h;
    ...
    out->sources[4] = biosim_gpu_preamble_challenge_defs_h;
